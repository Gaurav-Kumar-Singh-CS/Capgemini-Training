...
public class Assignment3Q1 {
	public static void main(String[] args) {
		...
		Person per2 = new Person("Beta", 181, 74);
		Person per3 = new Person("Gamma", 170, 70);
		Person per4 = new Person("Ben", 165, 60);
		Person per5 = new Person("Emma", 169, 65);
		Person per6 = new Person("XanXan", 165, 59);
